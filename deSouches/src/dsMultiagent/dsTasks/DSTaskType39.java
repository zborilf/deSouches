...
public class DSTaskType39 extends DSTaskType {
    ...
    DSPlan makePlanL2(){
        ...
        DSConnect connect=new DSConnect(PMaster.getEI(),getConnectDirection(PLeutnant2),PLeutnant1.getEntityName());
        plan.appendAction(connect);
    ...
    DSPlan makePlanL3(){
        ...
        DSConnect connect=new DSConnect(PMaster.getEI(),getConnectDirection(PLeutnant3),PMaster.getEntityName());
        plan.appendAction(connect);
    ...
    public Point formationPosition(DSAgent agent, Point position) {
        ...
        if(agent==PLeutnant2)
            return(new Point(position.x-1,position.y+3));
        if(agent==PLeutnant3)
