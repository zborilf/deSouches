...
public class DSTask {
    ...
    final static int __DSTMaster=1;
    final static int __DSTCaptain=2;
    final static int __DSTSoldier1=3;
    final static int __DSTSoldier2=4;
    final static int __DSTSoldier3=5;
...
// 42
    ...
    public DSTask(String name, int deadline, int reward, DSBody body){//, LinkedList<Integer> typesNeeded){
        PTaskName=name;
        PDeadline=deadline;
        PReward=reward;
        PTaskBody=body;
