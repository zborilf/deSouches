...
public class DSTaskType31 extends DSTaskType {
    ...
    DSPlan makePlanL1(){
        ...
        DSConnect connect=new DSConnect(PMaster.getEI(),getConnectDirection(PLeutnant1),PLeutnant3.getEntityName());
    ...
    DSPlan makePlanL2(){
        ...
        DSConnect connect=new DSConnect(PMaster.getEI(),getConnectDirection(PLeutnant2),PMaster.getEntityName());
        plan.appendAction(connect);
    ...
    DSPlan makePlanL3(){
        ...
        DSConnect connect=new DSConnect(PMaster.getEI(),getConnectDirection(PLeutnant3),PLeutnant1.getEntityName());
        plan.appendAction(connect);
