...
public class DSSynchronize {
    ...
    synchronized public DSMap synchronizePosition(DSAgent agent, int absX, int absY) { // agent nastavi jako PMAp
        ...
        if(PMasterMap==null) {
            ...
            System.out.println(" Delam mastermapu "+agent.getEntityName()+" krok "+ agent.getStep()+"\n");
